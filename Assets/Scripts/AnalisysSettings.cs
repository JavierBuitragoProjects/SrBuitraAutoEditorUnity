...
public class AnalisysSettings : MonoBehaviour
{
    
    public GameObject reanalyzeButton;
    public Toggle saveSilencesToggle;
    ...
    public Image timelineBackGround;
    public Toggle[] channels;
